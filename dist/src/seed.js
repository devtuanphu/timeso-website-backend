...
const khachHangData = [
    {
        ...
        noi_dung: "Timeso đã giúp chúng tôi tiết kiệm 60% thời gian quản lý nhân sự. Hệ thống chấm công tự động và báo cáo thông minh thực sự ấn tượng.",
        so_sao: 5,
    },
    {
        ten: "Trần Minh Tuấn",
        ...
        noi_dung: "Từ khi sử dụng Timeso, việc quản lý đội ngũ 200+ nhân viên trở nên dễ dàng hơn bao giờ hết. Highly recommended!",
        so_sao: 5,
    },
    {
        ten: "Lê Thị Hương",
        chuc_vu: "HR Manager",
        cong_ty: "Công ty XYZ",
        noi_dung: "Tính năng sắp ca thông minh của Timeso thực sự tuyệt vời. AI đề xuất lịch làm việc tối ưu cho từng nhân viên.",
        so_sao: 5,
    },
];
const baiVietData = [
    {
        ...
        mo_ta: "Khám phá 5 xu hướng quan trọng nhất trong quản trị nhân sự năm 2026 mà doanh nghiệp cần nắm bắt.",
        noi_dung: `
## Giới thiệu
...
const trangChuData = {
    seo: {
        ...
        mo_ta: "Timeso - Nền tảng quản lý nhân sự, chấm công, sắp ca thông minh hàng đầu Việt Nam. Tối ưu hóa vận hành với AI.",
    ...
    hero: {
        ...
        mo_ta: "Timeso giúp doanh nghiệp tối ưu hóa quy trình quản lý nhân sự với công nghệ AI tiên tiến. Chấm công, sắp ca, tính lương - tất cả trong một nền tảng.",
...
const chamCongData = {
    seo: {
        ...
        mo_ta: "Hệ thống chấm công đa phương thức: GPS, Face ID, QR Code. Tự động hóa hoàn toàn quy trình chấm công.",
        tu_khoa: "chấm công, GPS, Face ID, QR Code, chấm công online",
    },
    hero: {
        tieu_de: "Chấm Công Thông Minh",
        tieu_de_noi_bat: "Đa Phương Thức",
        mo_ta: "Hệ thống chấm công hiện đại với GPS, Face ID và QR Code. Chính xác, nhanh chóng, dễ sử dụng.",
        hien_thi_badges: true,
        app_store_url: "https://apps.apple.com/app/timeso",
        google_play_url: "https://play.google.com/store/apps/details?id=com.timeso",
    },
...
const sapCaThongMinhData = {
    ...
    hero: {
        ...
        mo_ta: "AI phân tích và tự động sắp xếp lịch làm việc tối ưu. Tiết kiệm thời gian, tối ưu nguồn lực.",
        hien_thi_badges: true,
        app_store_url: "https://apps.apple.com/app/timeso",
        google_play_url: "https://play.google.com/store/apps/details?id=com.timeso",
    },
...
const quanLyTaiSanData = {
    ...
    hero: {
        ...
        mo_ta: "Theo dõi toàn bộ tài sản công ty từ laptop đến xe cộ. Kiểm kê, bảo trì, phân bổ dễ dàng.",
        hien_thi_badges: true,
        app_store_url: "https://apps.apple.com/app/timeso",
        google_play_url: "https://play.google.com/store/apps/details?id=com.timeso",
    },
...
const veChungToiData = {
    ...
    hero: {
        ...
        mo_ta: "Chúng tôi là đội ngũ đam mê công nghệ, cam kết mang đến giải pháp quản lý nhân sự tốt nhất.",
