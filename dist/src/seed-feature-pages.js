...
async function main() {
    ...
    const hrHeroImg = await uploadFile("figma_assets/e5cdb3bf6163b94e35b1793feba180e15ba1ccd0.png", "Quản lý nhân sự hero");
    const attendanceHeroImg = await uploadFile("figma_assets/e8c319bd8f21d8adccc55871dd5f19444f498af7.png", "Chấm công hero");
    const attendanceFeature1Img = await uploadFile("figma_assets/921e6cc61bedd673112e65a4e2276974bbfea3aa.png", "Chấm công feature 1");
    const attendanceFeature2Img = await uploadFile("figma_assets/96e33c5f95eab3e4b2fb914ad8d4898e0f0e3297.png", "Chấm công feature 2");
    const schedulingHeroImg = await uploadFile("figma_assets/3d4deb506f9fd18b409cb0aafaf717ea62928e41.png", "Sắp ca hero");
    const orderHeroImg = await uploadFile("figma_assets/f39d24ee2279b11358426c47a3f20d748d9bfa5a.png", "Đơn hàng hero");
    const assetHeroImg = await uploadFile("figma_assets/9c2595df78e94d7405bb4b531ceb329dbb04e509.png", "Tài sản hero");
    // CTA image (shared)
    console.log("\n📂 CTA images:");
    const ctaImage = await uploadFile("images/recruitment/0fde196edc3946aa5fa9569f9c8de980a700b345.png", "CTA image");
    // DaLinhVuc images
    console.log("\n📂 DaLinhVuc images:");
    ...
    for (const p of dlvPaths) {
        ...
        if (img)
            daLinhVucImages.push(img.id);
    }
    // WhyChoose background images
    console.log("\n📂 WhyChoose background images:");
    const schedulingWhyBg = await uploadFile("figma_assets/928c2c2cdc67a507253902630c28d4919917d32c.png", "Scheduling why choose bg");
    const assetWhyBg = await uploadFile("figma_assets/68937d368169e6dd5d1307e63a2509097b9d3014.png", "Asset why choose bg");
    const totalImages = [
        hrHeroImg,
        attendanceHeroImg,
    ...
    const sharedCta = (title, subtitle) => {
        var _a;
        return ({
            tieu_de: title,
            mo_ta: subtitle,
            hinh_anh: (_a = ctaImage === null || ctaImage === void 0 ? void 0 : ctaImage.id) !== null && _a !== void 0 ? _a : null,
            mau_nen: "#E6FEFF",
            app_store_url: "#",
            google_play_url: "#",
        });
    ...
    await updateSingleType("quan-ly-nhan-su", {
        seo: {
            ...
            mo_ta: "Giải pháp quản lý nhân sự toàn diện: hồ sơ nhân viên, phân quyền, đánh giá hiệu suất và báo cáo thông minh.",
        },
        hero: {
            tieu_de: "Quản lý nhân sự thông minh với AI Timeso",
            mo_ta: "Timeso ứng dụng AI để tự động xử lý quy trình nhân sự, từ ca làm, theo dõi hiệu suất đến tính lương. Mọi thao tác đều được tính giản để cửa hàng vận hành mượt mà và hiện đại.",
            app_store_url: "#",
            google_play_url: "#",
        },
        tinh_nang: [
    ...
    await updateSingleType("cham-cong", {
        seo: {
            ...
            mo_ta: "Hệ thống chấm công tự động bằng QR & GPS. Theo dõi giờ làm, hiệu suất nhân viên theo thời gian thực.",
        },
        hero: {
            tieu_de: "Chấm Công & AI Theo Dõi Hiệu Suất",
            mo_ta: "Hệ thống Timeso theo dõi giờ làm, công suất và hiệu suất liên tục của từng nhân viên theo thời gian thực, giúp bạn nhanh chóng nắm bắt biến động, tối ưu quy trình và giảm thiểu sai sót trong quản lý.",
            app_store_url: "#",
            google_play_url: "#",
        },
        tinh_nang: [
            {
                ...
                mau_nen: "#b7ffff",
                hinh_anh: (_a = attendanceFeature1Img === null || attendanceFeature1Img === void 0 ? void 0 : attendanceFeature1Img.id) !== null && _a !== void 0 ? _a : null,
            },
            {
                ...
                mau_nen: "#f5f5f5",
                hinh_anh: (_b = attendanceFeature2Img === null || attendanceFeature2Img === void 0 ? void 0 : attendanceFeature2Img.id) !== null && _b !== void 0 ? _b : null,
            },
        ],
        da_linh_vuc: sharedDaLinhVuc,
        why_choose: {
    ...
    await updateSingleType("sap-ca-thong-minh", {
        seo: {
            ...
            mo_ta: "AI tối ưu lịch làm việc theo nhu cầu thực tế: giảm thiếu người, hạn chế trùng ca và tiết kiệm đến 60% thời gian sắp ca thủ công.",
        },
        hero: {
        ...
        why_choose: {
            tieu_de: "Lý do nên chọn Timeso?",
            hinh_nen: (_c = schedulingWhyBg === null || schedulingWhyBg === void 0 ? void 0 : schedulingWhyBg.id) !== null && _c !== void 0 ? _c : null,
            cac_ly_do: [
    ...
    await updateSingleType("quan-ly-don-hang", {
        seo: {
            ...
            mo_ta: "Timeso giúp cửa hàng tạo và quản lý đơn hàng nhanh chóng, theo dõi đơn rõ ràng, tránh nhầm lẫn và phục vụ đúng thời gian.",
        },
        hero: {
            tieu_de: "Quản Lý Đơn Hàng",
            mo_ta: "Timeso giúp cửa hàng tạo và quản lý đơn hàng nhanh chóng. Khi khách đến, nhân viên chỉ cần bấm tạo đơn và đặt lịch phục vụ cho khách ngay trên hệ thống, giúp theo dõi đơn rõ ràng, tránh nhầm lẫn và phục vụ đúng thời gian.",
            app_store_url: "#",
            google_play_url: "#",
        },
        tinh_nang: [],
    ...
    await updateSingleType("quan-ly-tai-san", {
        seo: {
            ...
            mo_ta: "Timeso giúp bạn theo dõi tài sản, thiết bị và kho hàng một cách rõ ràng và chính xác.",
        },
        hero: {
            tieu_de: "Quản Lý Tài Sản Thông Minh & Chính Xác",
            mo_ta: "Timeso giúp bạn theo dõi tài sản, thiết bị và kho hàng một cách rõ ràng và chính xác. Mọi thay đổi đều được cập nhật theo thời gian thực, giúp giảm thất thoát và tối ưu chi phí vận hành.",
            app_store_url: "#",
            google_play_url: "#",
        },
        tinh_nang: [],
        ...
        why_choose: {
            tieu_de: "Lý do nên chọn Timeso?",
            hinh_nen: (_d = assetWhyBg === null || assetWhyBg === void 0 ? void 0 : assetWhyBg.id) !== null && _d !== void 0 ? _d : null,
            cac_ly_do: [
                { tieu_de: "Giải pháp quản lý toàn diện, tiết kiệm thời gian" },
                { tieu_de: "Tính năng vượt trội, giúp tối ưu hóa mọi quy trình" },
