...
async function main() {
    ...
    const dashboardImg = await uploadFile("images/recruitment/85b42fc8e141b80565f28cff8ba1d70ac8e47064.png", "Dashboard");
    const challengeImg = await uploadFile("images/recruitment/e2944d07e911aa0580feeda675a549795c0a1050.png", "Challenges");
    const ctaImg = await uploadFile("images/recruitment/0fde196edc3946aa5fa9569f9c8de980a700b345.png", "CTA");
    // Solution images
    const solImgs = [];
    const solPaths = [
    ...
    await updateSingleType("tuyen-dung", {
        seo: {
            ...
            mo_ta: "Tự động hóa tuyển dụng từ lọc hồ sơ đến phỏng vấn. Giúp doanh nghiệp thu hút và tuyển chọn nhân tài nhanh chóng.",
        },
        hero: {
            tieu_de: "Timeso - Giải Pháp Chấm Dứt Nỗi Lo Tuyển Dụng",
            mo_ta: "Tự động hóa tuyển dụng từ lọc hồ sơ đến phỏng vấn, Giúp doanh nghiệp thu hút và tuyển chọn nhân tài nhanh chóng – hiệu quả với công nghệ AI phỏng vấn và đánh giá ứng viên. Timeso giúp các đối tác kinh doanh tự động, giống như một nền tảng HR bạn cần.",
            app_store_url: "#",
            google_play_url: "#",
        },
        dich_vu: {
            ...
            mo_ta: "Timeso giúp bạn tự động hóa toàn bộ quy trình tuyển dụng, tối ưu thời gian – giảm chi phí – nâng cao chất lượng ứng viên, từ đó xây dựng đội ngũ nhân sự mạnh mẽ hơn.",
            hinh_anh: (_a = dashboardImg === null || dashboardImg === void 0 ? void 0 : dashboardImg.id) !== null && _a !== void 0 ? _a : null,
            dich_vu: [
                {
        ...
        thach_thuc: {
            ...
            hinh_anh: (_b = challengeImg === null || challengeImg === void 0 ? void 0 : challengeImg.id) !== null && _b !== void 0 ? _b : null,
            thach_thuc: [
        ...
        giai_phap: {
            ...
            mo_ta: "Timeso tự động hóa toàn bộ quy trình tuyển dụng — từ đăng tin, lọc hồ sơ đến phỏng vấn video — giúp doanh nghiệp tiết kiệm thời gian, chi phí và tuyển đúng người nhanh hơn.",
            giai_phap: [
                {
                    ...
                    icon: (_d = (_c = solImgs[0]) === null || _c === void 0 ? void 0 : _c.id) !== null && _d !== void 0 ? _d : null,
                },
                {
                    tieu_de: "Phỏng vấn trực tiếp trong app",
                    mo_ta: "Phỏng vấn từ xa ngay trong ứng dụng, đánh giá ứng viên hiệu quả mà không cần gặp trực tiếp.",
                    icon: (_f = (_e = solImgs[1]) === null || _e === void 0 ? void 0 : _e.id) !== null && _f !== void 0 ? _f : null,
                },
                {
                    ...
                    icon: (_h = (_g = solImgs[2]) === null || _g === void 0 ? void 0 : _g.id) !== null && _h !== void 0 ? _h : null,
                },
                {
                    tieu_de: "Quy trình hiện đại đơn giản",
                    mo_ta: "Mọi bước tuyển dụng được chuẩn hóa và tự động hóa, giảm sai sót và tăng minh bạch.",
                    icon: (_k = (_j = solImgs[3]) === null || _j === void 0 ? void 0 : _j.id) !== null && _k !== void 0 ? _k : null,
                },
                {
                    tieu_de: "Theo dõi ứng viên dễ dàng",
                    mo_ta: "Cập nhật tiến độ, ghi chú và trạng thái ứng viên trên một hệ thống thống nhất.",
                    icon: (_m = (_l = solImgs[4]) === null || _l === void 0 ? void 0 : _l.id) !== null && _m !== void 0 ? _m : null,
                },
                {
                    tieu_de: "Xây dựng đội ngũ mạnh mẽ",
                    mo_ta: "Kết nối tuyển dụng – chấm công – hiệu suất để phát triển đội ngũ ổn định, hiệu quả.",
                    icon: (_p = (_o = solImgs[5]) === null || _o === void 0 ? void 0 : _o.id) !== null && _p !== void 0 ? _p : null,
                },
            ],
        },
        why_choose: {
            ...
            cac_ly_do: [
                {
                    ...
                    icon: (_r = (_q = whyIcons[0]) === null || _q === void 0 ? void 0 : _q.id) !== null && _r !== void 0 ? _r : null,
                },
                {
                    tieu_de: "Tiết kiệm chi phí",
                    mo_ta: "Cắt giảm chi phí đăng tin\nvà nhân sự tuyển dụng.",
                    icon: (_t = (_s = whyIcons[1]) === null || _s === void 0 ? void 0 : _s.id) !== null && _t !== void 0 ? _t : null,
                },
                {
                    tieu_de: "Dễ dùng, giao diện hiện đại",
                    mo_ta: "Giao diện trực quan giúp chủ doanh nghiệp\nvà nhân viên quản lý thao tác dễ dàng,\nkhông cần kiến thức công nghệ nhưng\nvẫn đạt hiệu quả cao.",
                    icon: (_v = (_u = whyIcons[2]) === null || _u === void 0 ? void 0 : _u.id) !== null && _v !== void 0 ? _v : null,
                },
            ],
        },
        cta: {
            ...
            hinh_anh: (_w = ctaImg === null || ctaImg === void 0 ? void 0 : ctaImg.id) !== null && _w !== void 0 ? _w : null,
            mau_nen: "#E6FEFF",
            app_store_url: "#",
            google_play_url: "#",
        },
