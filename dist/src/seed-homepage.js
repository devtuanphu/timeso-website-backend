...
async function seedHomepage() {
    ...
    for (const logo of IMAGE_MANIFEST.trustedByLogos) {
        ...
        if (uploaded)
            uploadedLogos.push(uploaded.id);
    }
    // --- AllInOne images ---
    console.log("\n📂 AllInOne module images:");
    const allInOneImg1 = await uploadFile(IMAGE_MANIFEST.allInOne[0].path, IMAGE_MANIFEST.allInOne[0].alt);
    const allInOneImg2 = await uploadFile(IMAGE_MANIFEST.allInOne[1].path, IMAGE_MANIFEST.allInOne[1].alt);
    // --- AI Section ---
    console.log("\n📂 AI Section images:");
    const aiMockup = await uploadFile(IMAGE_MANIFEST.aiSection.mockup.path, IMAGE_MANIFEST.aiSection.mockup.alt);
    const aiIcons = [];
    for (const icon of IMAGE_MANIFEST.aiSection.icons) {
        const uploaded = await uploadFile(icon.path, icon.alt);
        aiIcons.push((_a = uploaded === null || uploaded === void 0 ? void 0 : uploaded.id) !== null && _a !== void 0 ? _a : null);
    }
    // --- TargetAudience ---
    ...
    for (const img of IMAGE_MANIFEST.targetAudience) {
        ...
        targetImages.push((_b = uploaded === null || uploaded === void 0 ? void 0 : uploaded.id) !== null && _b !== void 0 ? _b : null);
    }
    // --- UserStories ---
    console.log("\n📂 UserStories icons:");
    const storyIcons = [];
    for (const icon of IMAGE_MANIFEST.userStories) {
        const uploaded = await uploadFile(icon.path, icon.alt);
        storyIcons.push((_c = uploaded === null || uploaded === void 0 ? void 0 : uploaded.id) !== null && _c !== void 0 ? _c : null);
    }
    // --- Testimonials ---
    console.log("\n📂 Testimonial images:");
    const avatar1 = await uploadFile(IMAGE_MANIFEST.testimonials.avatars[0].path, IMAGE_MANIFEST.testimonials.avatars[0].alt);
    const avatar2 = await uploadFile(IMAGE_MANIFEST.testimonials.avatars[1].path, IMAGE_MANIFEST.testimonials.avatars[1].alt);
    const companyLogo = await uploadFile(IMAGE_MANIFEST.testimonials.logo.path, IMAGE_MANIFEST.testimonials.logo.alt);
    // --- CTA ---
    console.log("\n📂 CTA images:");
    const ctaPhone = await uploadFile(IMAGE_MANIFEST.cta.phone.path, IMAGE_MANIFEST.cta.phone.alt);
    const totalUploaded = uploadedLogos.length +
        (allInOneImg1 ? 1 : 0) +
        (allInOneImg2 ? 1 : 0) +
        (aiMockup ? 1 : 0) +
    ...
    const trangChuPayload = {
        // ─ SEO ─
        seo: {
            tieu_de: "Timeso - Nền tảng Quản lý Nhân sự bằng AI",
            mo_ta: "Timeso giúp doanh nghiệp tự động hóa HR bằng AI, từ tuyển dụng đến chấm công và quản lý hiệu suất, giảm giấy tờ để tập trung phát triển nhân tài.",
        ...
        all_in_one: {
            ...
            modules: [
                {
                    tieu_de: "Tuyển dụng",
                    mo_ta: "Tự động lọc CV, đánh giá ứng viên và quản lý toàn bộ quy trình tuyển dụng trên một nền tảng.",
                    hinh_anh: (_d = allInOneImg1 === null || allInOneImg1 === void 0 ? void 0 : allInOneImg1.id) !== null && _d !== void 0 ? _d : null,
                },
                {
                    tieu_de: "Quản lý nhân sự tự động",
                    mo_ta: "Lưu trữ hồ sơ điện tử, theo dõi hợp đồng – lương – phụ cấp và xử lý onboarding/offboarding tự động.",
                    hinh_anh: (_e = allInOneImg2 === null || allInOneImg2 === void 0 ? void 0 : allInOneImg2.id) !== null && _e !== void 0 ? _e : null,
                },
                {
                    tieu_de: "Chấm công & Theo dõi hiệu suất",
                    mo_ta: "Chấm công bằng AI (FaceID, GPS, Wi-Fi), phát hiện bất thường và đánh giá KPI theo thời gian thực.",
                    hinh_anh: (_f = allInOneImg1 === null || allInOneImg1 === void 0 ? void 0 : allInOneImg1.id) !== null && _f !== void 0 ? _f : null,
                },
                {
                    tieu_de: "Tạo đơn hàng",
                    mo_ta: "Timeso giúp cửa hàng tạo đơn nhanh chóng, thanh toán dễ dàng. Quản lý lịch hẹn, đơn hàng một cách rõ ràng.",
                    hinh_anh: (_g = allInOneImg2 === null || allInOneImg2 === void 0 ? void 0 : allInOneImg2.id) !== null && _g !== void 0 ? _g : null,
                },
                {
                    tieu_de: "Quản lý tài sản",
                    mo_ta: "Theo dõi thiết bị cấp phát, tình trạng sử dụng và lịch sử bàn giao theo từng nhân viên.",
                    hinh_anh: (_h = allInOneImg1 === null || allInOneImg1 === void 0 ? void 0 : allInOneImg1.id) !== null && _h !== void 0 ? _h : null,
                },
            ],
        },
        // ─ AI Section ─
        ...
        user_stories: {
            ...
            stories: [
                {
                    tieu_de: "Tuyển dụng",
                    mo_ta: "AI tự động sàng lọc hồ sơ, đánh giá ứng viên và rút ngắn 70% thời gian tuyển dụng cho doanh nghiệp.",
                    hinh_anh: (_t = storyIcons[0]) !== null && _t !== void 0 ? _t : null,
                    mau_nen: "#1570EF",
                },
                {
                    tieu_de: "Tính lương tự động",
                    mo_ta: "Hệ thống AI tính lương chính xác từ dữ liệu chấm công – ca làm, giảm lỗi thủ công và tăng hiệu suất vận hành.",
                    hinh_anh: (_u = storyIcons[1]) !== null && _u !== void 0 ? _u : null,
                    mau_nen: "#45556C",
                },
                {
                    tieu_de: "Quản lý đơn hàng",
                    mo_ta: "AI theo dõi toàn bộ vòng đời đơn hàng, tự động cập nhật trạng thái và tối ưu hiệu suất xử lý.",
                    hinh_anh: (_v = storyIcons[2]) !== null && _v !== void 0 ? _v : null,
                    mau_nen: "#2B7FFF",
                },
                {
                    tieu_de: "Quản lý kho",
                    mo_ta: "Quản lý tồn kho bằng AI, tự động cảnh báo thiếu hàng và tối ưu hiệu suất nhập – xuất mỗi ngày.",
                    hinh_anh: (_w = storyIcons[3]) !== null && _w !== void 0 ? _w : null,
                    mau_nen: "#01BCBC",
                },
            ],
        },
        ...
        pricing: {
            ...
            mo_ta: "Select from best plans, ensuring a perfect match. Need more or less? Customize your subscription for a seamless fit!",
            goi_gia: [
                {
                    ten_goi: "Free",
                    gia: "$0",
        ...
        testimonials: {
            ...
            danh_gia: [
                {
                    noi_dung: "Giao diện người dùng rất trực quan, giúp việc thực hiện công việc trở nên dễ dàng. Dù là mua bán hay quản lý danh mục tài sản số đa dạng của tôi, mọi thứ đều thuận tiện.",
                    ten: "Mahmud Niloy",
                    chuc_vu: "Super Admin",
                    so_sao: 5,
                    avatar: (_x = avatar1 === null || avatar1 === void 0 ? void 0 : avatar1.id) !== null && _x !== void 0 ? _x : null,
                    logo_cong_ty: (_y = companyLogo === null || companyLogo === void 0 ? void 0 : companyLogo.id) !== null && _y !== void 0 ? _y : null,
                },
                {
                    noi_dung: "Tôi là một Freelancer, và việc quản lý thu nhập từ nhiều nền tảng số khác nhau từng là một rắc rối lớn. Mọi thứ thay đổi cho đến khi tôi khám phá ra Block/Timeso.",
                    ten: "Mahmud Niloy",
                    chuc_vu: "Super Web Designer",
                    so_sao: 5,
                    avatar: (_z = avatar2 === null || avatar2 === void 0 ? void 0 : avatar2.id) !== null && _z !== void 0 ? _z : null,
                    logo_cong_ty: (_0 = companyLogo === null || companyLogo === void 0 ? void 0 : companyLogo.id) !== null && _0 !== void 0 ? _0 : null,
                },
                {
                    noi_dung: "Giao diện người dùng rất trực quan, giúp việc thực hiện công việc trở nên dễ dàng. Dù là mua bán hay quản lý danh mục tài sản số đa dạng của tôi, mọi thứ đều thuận tiện.",
                    ten: "Mahmud Niloy",
                    chuc_vu: "Super Admin",
                    so_sao: 5,
                    avatar: (_1 = avatar1 === null || avatar1 === void 0 ? void 0 : avatar1.id) !== null && _1 !== void 0 ? _1 : null,
                    logo_cong_ty: (_2 = companyLogo === null || companyLogo === void 0 ? void 0 : companyLogo.id) !== null && _2 !== void 0 ? _2 : null,
                },
                {
                    noi_dung: "Tôi là một Freelancer, và việc quản lý thu nhập từ nhiều nền tảng số khác nhau từng là một rắc rối lớn. Mọi thứ thay đổi cho đến khi tôi khám phá ra Block/Timeso.",
                    ten: "Mahmud Niloy",
                    chuc_vu: "Super Web Designer",
                    so_sao: 5,
                    avatar: (_3 = avatar2 === null || avatar2 === void 0 ? void 0 : avatar2.id) !== null && _3 !== void 0 ? _3 : null,
                    logo_cong_ty: (_4 = companyLogo === null || companyLogo === void 0 ? void 0 : companyLogo.id) !== null && _4 !== void 0 ? _4 : null,
                },
            ],
        },
        // ─ CTA ─
        cta: {
            ...
            mo_ta: "Dễ dàng theo dõi và tối ưu hiệu suất làm việc của bạn mọi lúc, mọi nơi với bản dùng thử miễn phí.",
            hinh_anh: (_5 = ctaPhone === null || ctaPhone === void 0 ? void 0 : ctaPhone.id) !== null && _5 !== void 0 ? _5 : null,
            app_store_url: "#",
            google_play_url: "#",
        },
    };
